<?php session_start(); ?>
<form style="display:none" id="gotologinchangeacc" target="_top" method="GET" action="login.php"></form>
<?php 
if(!isset($_SESSION['accid'])){
    echo "<script type='text/javascript'>$('#gotologinchangeacc').submit()</script>";
	exit;
}
