...
<body>
    ...
    <div class="container flex-row flex-wrap mt-3">
        <div class="row">
            ...
            <form id="acc_login_form" action="login.php" method="GET" target="log_acc_frame">
            ...
            <div class="info col-6">        
                <form id="user_login_form" action="login.php" method="GET" target="log_user_frame">
                    <p style="font-weight: 600;">pet viewer account(user)</p>
    ...
    <form id='getaccform' style="visibility: hidden" method="GET" action="account.php" target="_top"></form>
    <form id='getuserform' style="visibility: hidden" method="GET" action="user.php" target="_top"></form>
    <iframe src="" name="log_acc_frame" style="display: none;"></iframe>
    <iframe src="" name="log_user_frame" style="display: none;"></iframe>
 	<script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>
<script src="/js/back_animations.js"></script>
<?php
// if(isset($_SESSION['accid'])){
//     echo "<script type='text/javascript'>alert('session accid = {$_SESSION['accid']}')</script>";
...
if(isset($_GET['acc_log_btn'])){
    ...
    if(!$conn){
        ...
        if($result->num_rows==0){
            ...
            mysqli_close($conn);
            echo "<script type='text/javascript'>$('#getaccform').submit()</script>";
            // echo "<script type='text/javascript'>$('#log_acc_id').val($acc_id);</script>";
            // echo "<script type='text/javascript'>document.querySelector('#log_acc_form').submit();</script>";
