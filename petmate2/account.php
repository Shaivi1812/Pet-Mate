...
<form style="display: none" id="acc_set_form" action="changeacc.php" method="post" target="_blank">
	...
	<!-- <input type="text" name="acc_update" id="acc_update" style="display: none;"> -->
...
<form style="visibility: hidden" id="gotologin" target="_top" method="GET" action="login.php"></form>
<!-- <form style="visibility: hidden" id="reload_page" target="_top" method="GET" action="account.php">
	<input type="text" name="accid" id="reload_page_accid">
</form>
 -->
...
// $("#acc_update").val(acc_id);
// $("#pet_accid").val(acc_id);
// $("#reload_page_accid").val(acc_id);
// $("#delaccid").val(acc_id);
    ...
    buttons: [
        {
            ...
            click: function() {
    			...
    			// document.querySelector("#reload_page").submit();
            }
        },
        {
            icon:"fas fa-paw",
