<?php session_start(); ?>
<form style="display:none" id="gotologinchangepets" target="_top" method="GET" action="login.php"></form>
<?php 
if(!isset($_SESSION['accid'])){
    echo "<script type='text/javascript'>$('#gotologinchangepets').submit()</script>";
	exit;
}
$acc_id = $_SESSION['accid'];
function compress_png($source,$min_quality=60,$max_quality = 75)
{
    $compressed_png_content = shell_exec("C:\\Users\\shaiv_000\\Desktop\\pngquant\\pngquant --quality=$min_quality-$max_quality - < ".$source." > C:\\wamp64\\www\\uploads\\temporary.png");
    return base64_encode(file_get_contents("C:/wamp64/www/uploads/temporary.png"));
}
function compress_jpeg($source,$quality=75)
{
    $compressed_jpeg_content = shell_exec("C:\\Users\\shaiv_000\\Desktop\\mozjpeg\\cjpeg -quality $quality ".$source." > C:\\wamp64\\www\\uploads\\temporary.jpg");
    return base64_encode(file_get_contents("C:/wamp64/www/uploads/temporary.jpg"));
}
print_r($_POST);
