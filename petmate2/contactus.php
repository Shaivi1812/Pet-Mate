...
<body>
    ...
    <div class="info">        
        <form id="feedback-form" action="contactus.php" method="POST">
            <div class="form-control"> 
              ...
              <label for="contact1">petmate1162000@gmail.com</label>
              <div class="radiostyle"><input type="checkbox" id="contact1" name="con1" value="petmate1162000@gmail.com" checked></div>
              <label for="contact2">petmate18122000@gmail.com</label>
              <div class=radiostyle><input type="checkbox" id="contact2" name="con2" value="petmate18122000@gmail.com"></div>
    ...
    if(isset($_POST['yourmail'])){
        ...
        if(isset($_POST['con1'])){
            $mail->Username   = 'petmate1162000@gmail.com';                     
            $mail->Password   = 'pet#mate#1162000';                               
            $mail->setFrom('petmate1162000@gmail.com', 'Ruben Dsouza');
            $mail->Send();

        }
        if(isset($_POST['con2'])){
            $mail->Username   = 'petmate18122000@gmail.com';                     
            $mail->Password   = 'pet#mate#18122000';                               
            $mail->setFrom('petmate18122000@gmail.com', 'Shaivi Haldankar');
            $mail->Send();
        }
    }
?>
